...
class QuestionnaireCoordinatorTests: XCTestCase {
    ...
    func testSelfDiagnosis() throws {
        ...
        XCTAssertFalse(tempVc.contextLabel.isHidden)
        ...
        XCTAssertFalse(coughVc.contextLabel.isHidden)
        ...
        XCTAssertFalse(anosmiaVc.contextLabel.isHidden)
        ...
        XCTAssertFalse(sneezeVc.contextLabel.isHidden)
        ...
        XCTAssertFalse(nauseaVc.contextLabel.isHidden)
    ...
    func testCheckin() throws {
        ...
        XCTAssertEqual(tempVc.questionDetail, "TEMPERATURE_DETAIL".localized)
        XCTAssertTrue(tempVc.contextLabel.isHidden)
        ...
        XCTAssertEqual(coughVc.questionDetail, "COUGH_DETAIL".localized)
        XCTAssertTrue(coughVc.contextLabel.isHidden)
        ...
        XCTAssertEqual(anosmiaVc.questionDetail, "ANOSMIA_DETAIL".localized)
        XCTAssertTrue(anosmiaVc.contextLabel.isHidden)
        ...
        XCTAssertEqual(sneezeVc.questionDetail, "SNEEZE_DETAIL".localized)
        XCTAssertTrue(sneezeVc.contextLabel.isHidden)
        ...
        XCTAssertEqual(nauseaVc.questionDetail, "NAUSEA_DETAIL".localized)
        XCTAssertTrue(nauseaVc.contextLabel.isHidden)
